                ...
                <div className="container my-3">
                    ...
                    <div className="row">
                        <div className="col-md-4">
                            <NewsItem newsTitle="Bad day for Ishaan" newsDescription="Didn't wake up on time!" newsImageURL={`https://www.aljazeera.com/wp-content/uploads/2022/12/2022-12-09T200724Z_1513593204_UP1EIC91JWAH0_RTRMADP_3_SOCCER-WORLDCUP-NLD-ARG-REPORT.jpg?resize=1920%2C1440`} />
                        </div>
                        <div className="col-md-4">
                            <NewsItem newsTitle="Good day for Ishaan" newsDescription="Got Extra Sleep  !" newsImageURL={`https://www.aljazeera.com/wp-content/uploads/2022/12/2022-12-09T200724Z_1513593204_UP1EIC91JWAH0_RTRMADP_3_SOCCER-WORLDCUP-NLD-ARG-REPORT.jpg?resize=1920%2C1440`} />
                        </div>
                        <div className="col-md-4">
                            <NewsItem newsTitle="Average day for Ishaan" newsDescription="Average of good and bad is still average!" newsImageURL={`https://www.aljazeera.com/wp-content/uploads/2022/12/2022-12-09T200724Z_1513593204_UP1EIC91JWAH0_RTRMADP_3_SOCCER-WORLDCUP-NLD-ARG-REPORT.jpg?resize=1920%2C1440`} />
                        </div>
                    </div>
                </div>
            </div>
